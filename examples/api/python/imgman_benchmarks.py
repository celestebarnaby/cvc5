...
def get_ast_size(prog):
    ...
    if isinstance(prog, Map):
        return get_ast_size(prog.extractor) + 2
    else:
        return 1
...
benchmarks = [
    ...
    # ),
    # Benchmark(
    #     Union([GetFace(8), Complement(EyesOpen())]),
    ...
    # ),
    # Benchmark(
    #     Map(IsObject("Wedding Gown"), IsFace(), GetAbove()),
    #     "Face of person wearing the wedding gown",
    #     "wedding",
    #     [
    #         "Ana Maria Photography-52.jpg",
    #         "Ana Maria Photography-80.jpg",
    #         "Ana Maria Photography-103.jpg",
    #         "Ana Maria Photography-49.jpg",
    #         "Ana Maria Photography-102.jpg",
    #     ],
    # ),
