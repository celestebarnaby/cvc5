...
class ApplyAction(Statement):
    ...
    def __str__(self):
        return type(self).__name__ + "(" + str(self.action) + ", " + str(self.extractor) + ")"


class ResizeStatement(Statement):
    def __init__(self, dimensions):
        self.dimensions = dimensions

    def __str__(self):
        return type(self).__name__ + "(" + str(self.dimensions) + ")"
...
class Crop(Action):
    # Maybe we want to add some padding to the crop?
    pass
...
class Map(Extractor):
    ...
    def __str__(self):
        return type(self).__name__ + "(" + str(self.extractor) + ", " + str(self.restriction) + ", " + str(self.position) + ")"
    ...
    def __eq__(self, other):
        if not isinstance(other, Map):
            return False
        return self.extractor == other.extractor and self.restriction == other.restriction and self.position == other.position
...
class Union(Extractor):
    def __init__(self, extractors: List[Extractor], val=None, output_under=None, output_over=None):
        super().__init__(val, output_under, output_over)
...
class Intersection(Extractor):
    ...
    def duplicate(self):
        return Intersection(self.extractors, self.val, self.output_under, self.output_over)
...
class Complement(Extractor):
    def __init__(self, extractor: Extractor, val=None, output_under=None, output_over=None):
        super().__init__(val, output_under, output_over)
        self.extractor = extractor
